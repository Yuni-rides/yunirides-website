...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.yunirides.com/blog' },
  openGraph: {
    ...
    url: 'https://www.yunirides.com/blog',
    images: [{ url: 'https://www.yunirides.com/images/og-image.png', width: 1200, height: 630, alt: 'Yuni Rides Blog' }],
    type: 'website',
  },
  twitter: {
