...
const trustBadges = [
  {
    ...
    description:
      "Every driver passes a comprehensive background check, drug test, and TB test before their first ride.",
  },
  {
    icon: FileCheck2,
    title: "IEP & IDEA Compliant",
    description:
      "Trained and certified to meet IEP and IDEA requirements for special needs student transport.",
  },
  {
    icon: Bus,
    title: "McKinney-Vento Certified Routes",
    description:
      "Dedicated routes and training for McKinney-Vento youth transportation compliance.",
  },
  {
    icon: Navigation,
    title: "GPS-Tracked Every Trip",
    description:
      "Real-time GPS tracking on every ride, with live updates available to families and districts.",
  },
  {
    icon: Accessibility,
    title: "ADA-Compliant Vehicles",
    description:
      "Our fleet meets ADA accessibility standards for students who need adaptive transport.",
  },
  {
    icon: MapPin,
    title: "Serving 6 States + DC",
    description:
      "Active driver positions across Washington, California, Arizona, Texas, Illinois, New York, and DC.",
  },
];
...
export default function TrustBadgeRow() {
  return (
    <section
      className="bg-[#FAF8F0] px-4 sm:px-12 py-6 relative overflow-hidden"
