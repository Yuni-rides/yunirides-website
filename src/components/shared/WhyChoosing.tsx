    ...
    <section className="bg-[#F7F5F0] pt-[60px] pb-[80px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-[22px]">
        ...
        >
          ...
          >
            <Image src="/images/school.png" alt="School Districts" fill className="object-cover" />
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.02, boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}
            whileTap={{ scale: 0.98 }}
            className="flex-1 min-h-[180px] md:h-[235px] rounded-[40px] bg-[#8B9B6A] p-[24px_28px] md:p-[28px_36px] flex flex-col justify-center box-border"
          >
            <h3 className="font-heading text-[18px] md:text-[20px] font-bold text-[#1a1a1a] m-0 mb-[10px]">School Districts:</h3>
            <p className="font-body text-[12.5px] text-[#1a1a1a] leading-[1.75] m-0 text-justify">
        ...
        >
          <motion.div
            ...
            className="flex-1 min-h-[180px] md:h-[235px] rounded-[40px] bg-[#8B9B6A] p-[24px_28px] md:p-[28px_36px] flex flex-col justify-center box-border"
          >
            <h3 className="font-heading text-[18px] md:text-[20px] font-bold text-[#1a1a1a] m-0 mb-[10px]">Hospitals &amp; Healthcare Facilities:</h3>
            <p className="font-body text-[12.5px] text-[#1a1a1a] leading-[1.75] m-0 text-justify">
          ...
          <motion.div
            ...
            className="w-full md:w-[302px] h-[220px] md:h-[235px] rounded-[40px] overflow-hidden shrink-0 relative shadow-[0_4px_20px_rgba(0,0,0,0.12)]"
          >
            <Image src="/images/hospital.png" alt="Hospitals & Healthcare" fill className="object-cover" />
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div
            ...
            className="w-full md:w-[302px] h-[220px] md:h-[235px] rounded-[40px] overflow-hidden shrink-0 relative shadow-[0_4px_20px_rgba(0,0,0,0.12)]"
          >
            <Image src="/images/parents.png" alt="Parents, Students & Guardians" fill className="object-cover" />
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.02, boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}
            whileTap={{ scale: 0.98 }}
            className="w-full md:flex-1 lg:w-[628px] min-h-[180px] md:h-[235px] rounded-[40px] bg-[#8B9B6A] p-[24px_28px] md:p-[28px_32px] flex flex-col justify-center box-border lg:shrink-0"
          >
            <h3 className="font-heading text-[18px] md:text-[20px] font-bold text-[#1a1a1a] m-0 mb-[10px]">Parents, Students &amp; Guardians.</h3>
            <p className="font-body text-[12.5px] text-[#1a1a1a] leading-[1.75] m-0 text-justify">
          ...
          >
            ...
            <motion.button
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.97 }}
              className="btn-primary w-full md:w-[302px] h-[70px]"
            >
              Discuss with Us
            </motion.button>
          </motion.div>
