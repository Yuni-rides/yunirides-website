...
export default function TestimonialsSection() {
  ...
  return (
    <section className="w-full bg-[#FAF8F0] pt-[60px] pb-[80px] px-4 md:px-[79px]">
      ...
      <div className="relative bg-[#EFF2FF] rounded-[40px] py-[48px] overflow-visible">
        ...
        <div className="hidden md:grid md:grid-cols-[1fr_516px_1fr] gap-4 items-center px-6">
          ...
          <div className="h-[330px] bg-[#822C89] rounded-[20px] p-7 box-border flex flex-col gap-[18px] shadow-[0_12px_40px_rgba(130,44,137,0.35)] border-2 border-white/15 transition-all duration-300 hover:-translate-y-3 hover:shadow-[0_20px_52px_rgba(130,44,137,0.5)] z-10 relative">
        ...
        <div className="md:hidden px-4">
          <div className="bg-[#822C89] rounded-[20px] p-6 box-border flex flex-col gap-[18px] shadow-[0_12px_40px_rgba(130,44,137,0.35)] border-2 border-white/15">
          ...
          <div className="flex justify-between mt-4 gap-3">
            <button onClick={() => setActive(prev)} className="flex-1 py-2 rounded-xl bg-[#822C89]/20 text-[#822C89] font-semibold text-sm transition-all duration-200 hover:bg-[#822C89]/30 active:scale-95">← Prev</button>
            <button onClick={() => setActive(next)} className="flex-1 py-2 rounded-xl bg-[#822C89]/20 text-[#822C89] font-semibold text-sm transition-all duration-200 hover:bg-[#822C89]/30 active:scale-95">Next →</button>
          </div>
        </div>
